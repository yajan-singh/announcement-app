...
export default ({
  ...
  description = "Our community is dedicated to empowering traders of all levels. We offer personalized support, expert advice, and a wealth of resources to help you succeed in the trading world. Join us on Discord and Telegram to connect with fellow traders, share insights, and enhance your trading skills.",
  primaryButtonText = "View Plans",
  primaryButtonUrl = "#pricing-real",
