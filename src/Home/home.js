...
export default () => {
  ...
  return (
    <AnimationRevealPage>
      ...
      />
      <MainFeature
        subheading={<Subheading>Daily Routine</Subheading>}
      ...
      <MainFeature2
        ...
        heading={
          <>
            Why Not <HighlightedText>Us?</HighlightedText>
          </>
        }
        ...
        features={[
          {
            ...
            description:
              "We trade only when opportunities present themselves, avoiding unnecessary trades.",
            iconContainerCss: tw`bg-green-300 text-green-800`,
          },
          {
            Icon: faBrain,
            title: "Psychology Technicals",
            description:
              "We focus on both the psychology of trading and technical analysis.",
            iconContainerCss: tw`bg-red-300 text-red-800`,
          },
          {
            Icon: faEye,
            title: "Simplicity & Clarity",
            description: "Our approach is simple yet highly informative.",
            iconContainerCss: tw`bg-red-300 text-red-800`,
          },
          {
            Icon: faUsers,
            ...
            description:
              "Join a fast-growing community of traders with varying levels of expertise.",
            iconContainerCss: tw`bg-red-300 text-red-800`,
          },
          {
            Icon: faChartLine,
            ...
            description:
              "We are always improving and delivering the best possible insights.",
            iconContainerCss: tw`bg-red-300 text-red-800`,
          },
          {
            ...
            description:
              "We are readily available to answer any questions you may have.",
            iconContainerCss: tw`bg-red-300 text-red-800`,
          },
          //   {
          //     Icon: BriefcaseIcon,
          ...
          //     description:
          //       "Month-to-month subscriptions allow you to stop and start as needed.",
          //     iconContainerCss: tw`bg-red-300 text-red-800`,
          //   },
        ]}
      />
        ...
        plans={[
          {
            ...
            mainFeature: "For All",
            features: [
              "Discord and Telegram Community Chat",
              "Testimonials",
              "Trading Recap",
              "4 Trade Ideas Per Week (on Discord and Telegram Chat)",
            ],
          },
          {
            name: "Pro",
            ...
            features: [
              ...
              "Safe Trades Channel on Discord and Telegram",
              "Access to Unusual Whales",
              "Real-Time Stock News",
              "Real-Time Crypto News",
              "Questions and Answers",
              "Earnings and Events Channel on Discord",
            ],
            // featured: true,
          },
          {
            ...
            features: [
              ...
              "Aggressive Trades Channel on Discord and Telegram",
              "Day Trade Watch List",
              "Pro-Charts",
              "Access to Live Trading Sessions On Discord",
            ],
          },
        ]}
      />
